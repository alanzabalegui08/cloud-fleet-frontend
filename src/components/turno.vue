                ...
                <table id="table_turn" class="table"> 
                    ...
                    <tbody>
                        <tr v-for="(turno,index) in list" :key="index">
                            ...
                            <td>{{turno.input}}</td>
                            <td>{{turno.output}}</td>
                            <td><button type="button" class="btn cur-p btn-outline-danger"  @click="removeTurn(turno)"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
import { TIME_INPUT } from '../util/datafield';
export default {
  name : 'turno',
  props : {
      turn : {
